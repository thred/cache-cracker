...
class MathModule extends Module {
    ...
    constructor() {
        ...
        this.register(Definition.procedure("convert", "Converts the quantity to the specified unit.", [
        ...
        this.register(Definition.procedure("chain", "Chains the quantities (e.g. 4 ft 2 in).", [
        ...
        this.register(Definition.procedure("positiveOf", "Negates the negated quantity", [
            Definition.any("value", "The quantity")
        ], Definition.quantity("quantity", "The quantity unmodified"), (scope: Scope) => {
            return scope.requiredAsQuantity("value");
        }));

        this.register(Definition.procedure("negativeOf", "Negates the quantity", [
            Definition.any("value", "The quantity")
        ], Definition.quantity("quantity", "The negated quantity"), (scope: Scope) => {
            return scope.requiredAsQuantity("value").negate();
        }));

        this.register(Definition.procedure("add", "Adds the right quantity to the left one. This method is used for the '+' operation.", [
        ...
        this.register(Definition.procedure("subtract", "Subtracts the right quantity from the left one. This method is used for the '-' operation.", [
            Definition.any("left", "The left hand quantity"),
            Definition.any("right", "The right hand quantity")
        ...
        this.register(Definition.procedure("multiply", "Mutiplies the left quantity with the right one. This method is used for the '*' operation.", [
            Definition.any("left", "The left hand quantity"),
            Definition.any("right", "The right hand quantity")
        ...
        this.register(Definition.procedure("divide", "Divides the left quantity by the right one. This method is used for the '/' operation.", [
            Definition.any("left", "The left hand quantity"),
            Definition.any("right", "The right hand quantity")
        ...
        this.register(Definition.procedure("power", "Performs a power operation of the left quantity and the right one. This method is used for the '^' operation.", [
            Definition.any("left", "The left hand quantity"),
            Definition.any("right", "The right hand quantity")
        ...
        this.register(Definition.procedure("modulo", "Performs a modulo operation of the left quantity and the right one. This method is used for the 'mod' operation.", [
            Definition.any("left", "The left hand quantity"),
            Definition.any("right", "The right hand quantity")
        ...
        this.register(Definition.procedure("abs", "Ensures that the quantity has a positive value.", [
            Definition.any("value", "The quantity")
        ], Definition.quantity("quantity", "The quantity as positive value"), (scope: Scope) => {
            return scope.requiredAsQuantity("value").abs();
        }));

        this.register(Definition.procedure("round", "Rounds the quantity to the specified accuracy (e.g. 0.01).", [
            Definition.any("value", "The quantity"),
        ...
        this.register(Definition.procedure("floor", "Returns the greatest quantity less or equal the specified quantity (with the specified accuracy, e.g. 0.01).", [
            Definition.any("value", "The quantity"),
            Definition.any("accuracy", "The accuracy, default value is 1", Quantity.ONE)
        ...
        this.register(Definition.procedure("ceil", "Returns the smallest quantity greater or equal the specified quantity (with the specified accuracy, e.g. 0.01).", [
            Definition.any("value", "The quantity"),
            Definition.any("accuracy", "The accuracy, default value is 1", Quantity.ONE)
        ...
        this.register(Definition.procedure("random", "Returns a random quantity between (and including) 1 and the maximum quantity.", [
