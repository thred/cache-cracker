...
class MathModule extends Module {
    ...
    constructor() {
        ...
        this.register(Definition.procedure(Globals.PROCEDURE_CONVERT, {
        ...
        this.register(Definition.procedure(Globals.PROCEDURE_NEGATE, {
        ...
        this.register(Definition.procedure(Globals.PROCEDURE_ADD, {
        ...
        this.register(Definition.procedure(Globals.PROCEDURE_SUBTRACT, {
        ...
        this.register(Definition.procedure(Globals.PROCEDURE_MULTIPLY, {
        ...
        this.register(Definition.procedure(Globals.PROCEDURE_DIVIDE, {
        ...
        this.register(Definition.procedure(Globals.PROCEDURE_EXPONENTIATE, {
        ...
        this.register(Definition.procedure(Globals.PROCEDURE_MODULO, {
        ...
        this.register(Definition.procedure(Globals.PROCEDURE_ABS, {
        ...
        this.register(Definition.procedure(Globals.PROCEDURE_ROUND, {
        ...
        this.register(Definition.procedure(Globals.PROCEDURE_FLOOR, {
        ...
        this.register(Definition.procedure(Globals.PROCEDURE_CEIL, {
        ...
        this.register(Definition.procedure(Globals.PROCEDURE_RANDOM, {
